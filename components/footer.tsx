  ...
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 py-10 text-center md:flex-row md:text-left">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-sm text-muted-foreground md:justify-end">
          <p className="text-xs">
          ...
          <div className="inline-flex items-center gap-1.5 text-xs text-muted-foreground">
            <span>Built by</span>
            <a
              href="https://github.com/adityajha-coder"
              target="_blank"
